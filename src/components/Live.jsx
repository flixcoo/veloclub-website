                ...
                <div className="border-t-2 border-[var(--text-color)]">
                    {upcomingGigs.length > 0 ? (
                        upcomingGigs.map((gig) => (
                            <div key={`${gig.date}-${gig.venue}`} className="grid grid-cols-1 md:grid-cols-[100px_200px_1.5fr_auto] gap-4 py-6 px-4 border-b border-[var(--gray-light)] items-baseline hover:bg-[#EBEBEB] transition-colors">
                                {/* date */}
