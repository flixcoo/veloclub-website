        ...
        <div className="min-h-[80vh] py-12 px-0 md:py-32">
            <div className="max-w-275 mx-auto px-6">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-(--text-color)">1. Datenschutz auf einen Blick</h2>
                    <h3 className="text-xl font-semibold my-6 text-(--text-color)">Allgemeine Hinweise</h3>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-(--text-color)">2. Datenerfassung auf dieser Website</h2>
                    <h3 className="text-xl font-semibold my-6 text-(--text-color)">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h3>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
                        Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber.
                        Dessen Kontaktdaten können Sie dem Impressum dieser Website entnehmen.
                    </p>

                    <h3 className="text-xl font-semibold my-6 text-(--text-color)">Wie erfassen wir Ihre Daten?</h3>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-(--text-color)">3. Allgemeine Hinweise und Pflichtinformationen</h2>
                    <h3 className="text-xl font-semibold my-6 text-(--text-color)">Datenschutz</h3>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-(--text-color)">4. Eingebettete Inhalte</h2>
                    <h3 className="text-xl font-semibold my-6 text-(--text-color)">Spotify</h3>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
                    ...
                    <h3 className="text-xl font-semibold my-6 text-(--text-color)">Apple Music</h3>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-(--text-color)">5. Server-Log-Dateien</h2>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-4 text-(--text-color)">6. Ihre Rechte</h2>
                    <p className="text-base leading-relaxed mb-4 text-gray-800">
