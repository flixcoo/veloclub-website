...
const LegalNotice = () => {
    return (
        <div className="min-h-[80vh] py-32 px-0 md:py-8">
            <div className="max-w-[1100px] mx-auto px-6">
                ...
                <h1 className="text-5xl md:text-6xl font-black uppercase text-[var(--accent-color)] mb-12 leading-[0.9] tracking-[-1px]">Impressum</h1>
